...
// GameArkanoid.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGameArkanoidApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CGameArkanoidApp::OnAppAbout)
...
// Создание CGameArkanoidApp

CGameArkanoidApp::CGameArkanoidApp() noexcept
{
	...
	SetAppID(_T("GameArkanoid.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGameArkanoidApp

CGameArkanoidApp theApp;


// Инициализация CGameArkanoidApp

BOOL CGameArkanoidApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CGameArkanoidDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CGameArkanoidView));
	if (!pDocTemplate)
		return FALSE;
...
int CGameArkanoidApp::ExitInstance()
{
...
// Обработчики сообщений CGameArkanoidApp
...
void CGameArkanoidApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
